...
### Added
- HID key mapping unit tests covering a–z, A–Z, 0–9, Shift pairs, whitespace, punctuation, and unsupported characters
...
> This section documents the features present at the time of the first public release.
> Do not mark as released until the release phase is complete.
...
[Unreleased]: https://github.com/Shyam-Dev18/auto-type-x1/compare/v1.0.0...HEAD
